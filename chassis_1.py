...
# chassis_1.py
# Last updated to Pi 07/06 12:00 PM
...
STEERING_PIN = 27        # left/right joystick
THROTTLE_PIN = 22        # forward/backward joystick
GATE_PIN = 5
...
GATE_OPEN_TIME = 0.17    # Time gate stays open
...
TRIGGER_MARGIN = 50      # Fires if switch reads >= 1950
...
STEERING_MAX_LFT = 1730
STEERING_TYP     = 1490
STEERING_MIN_RGT = 1230
...
def async_fire_sequence():
    ...
    try:
        ...
        print("[SHOOTER] Done, reset the switch now")
...
def main():
    ...
    print("  Team East  chassis_1.py  07/06/2026 12:00  ")
    print("=============================================")
